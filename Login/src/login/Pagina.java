...
public class Pagina extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setFont(new java.awt.Font("Heebo", 3, 36)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setText("CodeStar");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Integer año = Integer.valueOf(jTextField5.getText());
        
        if (año > 2004){
            JOptionPane.showMessageDialog(null,"Tienes que ser mayor de edad para poder registrarte.");     
          }else{
            JOptionPane.showMessageDialog(null,"Bienvenido, ha completado su registro.");    
            this.dispose();
        }
