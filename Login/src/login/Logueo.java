...
public class Logueo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setFont(new java.awt.Font("Heebo", 3, 36)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("CodeStar");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(user.isEmpty() || password.isEmpty() ){
            ...
            JOptionPane.showMessageDialog(null,"Se necesita completar los espacios");
        } else{
               if(user.equals("admin") && password.equals("1234")){
                 JOptionPane.showMessageDialog(null,"Beinvenido");
               }else{
